#
# Be sure to run `pod lib lint ZFBLogin.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'ZFBLogin'
  s.version          = '0.1.0'
  s.summary          = 'A short description of ZFBLogin.'
...
TODO: Add long description of the pod here.
  ...
  s.source_files = 'ZFBLogin/Classes/**/*'
  
  # s.resource_bundles = {
  #   'ZFBLogin' => ['ZFBLogin/Assets/*.png']
  # }
